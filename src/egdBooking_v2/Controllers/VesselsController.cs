...
namespace egdbooking_v2.Controllers
{
    public class VesselsController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Length,Width,LloydsId,Tonnage,Anonymous,Deleted,EndHighlight")] Vessel vessel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit([Bind("Id,Name,Length,Width,LloydsId,Tonnage,Anonymous,Deleted,EndHighlight")] Vessel vessel)
        {
            if (ModelState.IsValid)
            {
