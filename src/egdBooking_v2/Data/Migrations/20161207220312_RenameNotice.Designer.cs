...
namespace egdbooking_v2.Data.Migrations
{
    ...
    [Migration("20161207220312_RenameNotice")]
    partial class RenameNotice
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("egdbooking_v2.Models.UserCompany", b =>
                {
            ...
            modelBuilder.Entity("egdbooking_v2.Models.VesselCompany", b =>
                {
                    b.Property<int>("CompanyId");

                    b.Property<int>("VesselId");

                    b.HasKey("CompanyId", "VesselId");

                    b.HasIndex("VesselId");

                    b.ToTable("VesselCompany");
                });
            ...
            modelBuilder.Entity("egdbooking_v2.Models.UserCompany", b =>
                {
                    b.HasOne("egdbooking_v2.Models.Company", "Company")
                        .WithMany("UserCompanies")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("egdbooking_v2.Models.User", "User")
                        .WithMany("UserCompanies")
